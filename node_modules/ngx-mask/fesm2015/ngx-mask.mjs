...
class MaskApplierService {
    ...
    _checkSymbolMask(inputSymbol, maskSymbol) {
        ...
        return (this.maskAvailablePatterns[maskSymbol] &&
            ((_a = this.maskAvailablePatterns[maskSymbol]) === null || _a === void 0 ? void 0 : _a.pattern) &&
            ((_c = (_b = this.maskAvailablePatterns[maskSymbol]) === null || _b === void 0 ? void 0 : _b.pattern) === null || _c === void 0 ? void 0 : _c.test(inputSymbol)));
    }
    _stripToDecimal(str) {
        return str
            .split('')
...
class MaskService extends MaskApplierService {
            ...
            inputValue !== '' && actualResult.length
                ? typeof this.selStart === 'number' && typeof this.selEnd === 'number'
                    ? inputValue.length > actualResult.length
                        ? actualResult.splice(this.selStart, 0, getSymbol !== null && getSymbol !== void 0 ? getSymbol : '')
                        : inputValue.length < actualResult.length
    ...
    getActualValue(res) {
        const compare = res
            ...
            .filter((symbol, i) => {
            var _a, _b;
            return this._checkSymbolMask(symbol, (_a = this.maskExpression[i]) !== null && _a !== void 0 ? _a : '') ||
                (this.maskSpecialCharacters.includes((_b = this.maskExpression[i]) !== null && _b !== void 0 ? _b : '') && symbol === this.maskExpression[i]);
        });
        if (compare.join('') === res) {
            return compare.join('');
        }
...
class MaskDirective {
    ...
    ngOnChanges(changes) {
        ...
        if (maskExpression) {
            ...
            if (maskExpression.currentValue && maskExpression.currentValue.split('||').length > 1) {
                ...
                this._maskValue = (_a = this._maskExpressionArray[0]) !== null && _a !== void 0 ? _a : '';
                this.maskExpression = (_b = this._maskExpressionArray[0]) !== null && _b !== void 0 ? _b : '';
                this._maskService.maskExpression = (_c = this._maskExpressionArray[0]) !== null && _c !== void 0 ? _c : '';
            }
        }
        ...
        if (value && value.toString().length >= 1) {
            ...
            for (const key in this._maskService.maskAvailablePatterns) {
                if (((_a = this._maskService.maskAvailablePatterns[key]) === null || _a === void 0 ? void 0 : _a.optional) &&
                    ((_b = this._maskService.maskAvailablePatterns[key]) === null || _b === void 0 ? void 0 : _b.optional) === true) {
            ...
            if (this._maskValue.indexOf('{') === 1 &&
                value.toString().length === this._maskValue.length + Number((_c = this._maskValue.split('{')[1]) === null || _c === void 0 ? void 0 : _c.split('}')[0]) - 4) {
                return null;
            }
    ...
    _validateTime(value) {
        ...
        if ((+((_a = value[value.length - 1]) !== null && _a !== void 0 ? _a : '') === 0 && value.length < rowMaskLen) || value.length <= rowMaskLen - 2) {
            return this._createValidationError(value);
        }
        return null;
    }
...
MaskDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: MaskDirective, deps: [{ token: DOCUMENT }, { token: MaskService }, { token: config }], target: i0.ɵɵFactoryTarget.Directive });
MaskDirective.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.0.2", type: MaskDirective, selector: "input[mask], textarea[mask]", inputs: { maskExpression: ["mask", "maskExpression"], specialCharacters: "specialCharacters", patterns: "patterns", prefix: "prefix", suffix: "suffix", thousandSeparator: "thousandSeparator", decimalMarker: "decimalMarker", dropSpecialCharacters: "dropSpecialCharacters", hiddenInput: "hiddenInput", showMaskTyped: "showMaskTyped", placeHolderCharacter: "placeHolderCharacter", shownMaskExpression: "shownMaskExpression", showTemplate: "showTemplate", clearIfNotMatch: "clearIfNotMatch", validation: "validation", separatorLimit: "separatorLimit", allowNegativeNumbers: "allowNegativeNumbers", leadZeroDateTime: "leadZeroDateTime" }, host: { listeners: { "paste": "onPaste()", "ngModelChange": "onModelChange($event)", "input": "onInput($event)", "blur": "onBlur()", "click": "onFocus($event)", "keydown": "onKeyDown($event)" } }, providers: [
        {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: MaskDirective, decorators: [{
            type: Directive,
            args: [{
...
MaskPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: MaskPipe, deps: [{ token: MaskApplierService }], target: i0.ɵɵFactoryTarget.Pipe });
MaskPipe.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: MaskPipe, name: "mask" });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: MaskPipe, decorators: [{
            type: Pipe,
            args: [{
                    name: 'mask',
                    pure: true,
